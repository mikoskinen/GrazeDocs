...
namespace GrazeDocs
{
    public class InjectLivePreviewMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            using (var newStream = new MemoryStream())
            {
                try
                {
                    ...
                    var inject = IsSupportedContentType(context.Response.ContentType) && context.Response.StatusCode != 304;
                    if (inject)
                    {
        ...
        private static string InjectScriptTag(string originalHtml)
        {
            ...
            signalRScript.SetAttribute("src", "https://cdn.jsdelivr.net/npm/@aspnet/signalr@1.1.2/dist/browser/signalr.min.js");
